...
export const About=() => {
    return (
        ...
        <section id= "about" className="text-white p-8">
            <h2 className="text-6xl font-bold mb-8">About <span className=" text-purple-500">Madan</span></h2>
            <div className="grid md:grid-cols-3 gap-8">
                <div className="border border-white/0 rounded-lg p-6">
                <h3 className="text-2xl font-bold mb-2">Background</h3>
                <p className="text-white/50 mb-6">I am a Software Engineer with expertise in React, Java, Spring Boot, JavaScript, Docker, and AWS Cloud. I specialize in designing and implementing scalable web applications and microservices, delivering high-quality, performance-driven solutions.</p>
...
`;
            ...
            <div className="border border-white/0 rounded-lg p-6">
                ...
                <p className="text-white/50 mb-4"> I&apos;m proficient in wide range of technologies and constantly updating my skill set</p>
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-8">
                ...
                <p className="text-white/50"> I believe writing clean, maintainablecide and following  best practices.</p>
                </div>
            </div>
            <div className="border border-white/0 rounded-lg p-6">
            ...
            <div>
                ...
                <p className="text-white/50">My goal is to continue growing as a developer, tackling challenging projects</p>
            </div>
