...
const metrics=[
    {
        ...
        description: 'Dedicated to honing my skills in full-stack developemnt.',
    },
    {
        id:2,
        value: '5+',
        label: 'Projects Completed',
        description: 'Small to Big platforms.',
    },
    {
        id:3,
        value: '5+',
    ...
    },
    {
        ...
        value: '99%',
        label: 'Code Quality',
        description: 'Dedicated to writing clean, efficient, maintabale code.',
    },
    {
        id:5,
        value: '5+',
        label: 'Commits on GitHub',
        description: 'Active contributer.',
    },
];
...
export const KeyMetrics=()=>{
    ...
    return (
        ...
        >
            ...
            className="text-6xl font-bold mb-13"
            >
                KEY METRICS
            </motion.h2>
