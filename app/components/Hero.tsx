...
import profilepic from "../../public/assets/hmm.png"
        ...
        <div className="relative overflow-clip min-h-screen text-white bg-[linear-gradient(to_bottom,#000,#340F41_35%,#8A3DA4_55%,#B993ED_85%)]">
            ...
            <div className="container relative mx-auto px-4 pt-12 pb-24">
                ...
                <div className="flex flex-col items-center justify-center text-center z-10">
                    ...
                    className="max-w-2xl"
                    >
                        <h1 className="text-6xl font-sans font-bold text-white/80 max-w-lg mx-auto leading-relaxed mb-6">
                            Hi, I am <br /> Madan<span className="text-purple-400"> Bandi</span>
                        </h1>

                        <p className="text-xl text-white/80 max-w-lg mx-auto leading-relaxed mb-10">
                        ...
                        <div className="flex gap-4 justify-center">
                            ...
                            className="px-6 py-3 bg-purple-500 rounded-full font-medium hover:bg-purple-700 transition-colors"
                            >
                                Contact Me
                            </motion.button>
                            <motion.button
                            whileHover={{scale:1.05}}
                            className="px-6 py-3 border-white/20 rounded-full font-medium hover:bg-purple-700 transition-colors"
                            >
                            View Work
                            </motion.button>
